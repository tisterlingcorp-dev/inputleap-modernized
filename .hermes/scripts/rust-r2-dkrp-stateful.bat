...
set "INTEROP_DIR=%BUILD_DIR%\rust-r2-dkrp-stateful"
set "EXE=%INTEROP_DIR%\rust-r2-dkrp-stateful.exe"
set "OBJ=%INTEROP_DIR%\DkrpStatefulInterop.obj"

...
set "INTEROP_DIR=%BUILD_DIR%\rust-r2-dmmv-stateful"
set "EXE=%INTEROP_DIR%\rust-r2-dmmv-stateful.exe"
set "OBJ=%INTEROP_DIR%\DmmvStatefulInterop.obj"

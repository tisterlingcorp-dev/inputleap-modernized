...
set "INTEROP_DIR=%BUILD_DIR%\rust-r2-dmrm-stateful"
set "EXE=%INTEROP_DIR%\rust-r2-dmrm-stateful.exe"
set "OBJ=%INTEROP_DIR%\DmrmStatefulInterop.obj"

...
set "INTEROP_DIR=%BUILD_DIR%\rust-r2-dkup-stateful"
set "EXE=%INTEROP_DIR%\rust-r2-dkup-stateful.exe"
set "OBJ=%INTEROP_DIR%\DkupStatefulInterop.obj"

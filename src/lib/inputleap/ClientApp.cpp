...
ClientApp::handle_client_connected()
{
    ...
    sendIpcConnectionState(IpcConnectionState::Connected, IpcConnectionRole::ClientPeer,
                           IpcIdentityPresence::LegacyUnavailable, "",
                           "server identity unavailable in legacy client handshake");
    resetRestartTimeout();
    updateStatus();
}
...
void ClientApp::handle_client_disconnected()
{
    ...
    sendIpcConnectionState(IpcConnectionState::Disconnected, IpcConnectionRole::ClientPeer,
                           IpcIdentityPresence::LegacyUnavailable, "",
                           "server identity unavailable in legacy client handshake");

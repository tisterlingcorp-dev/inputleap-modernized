...
public:
    ...
    */
    ...
    //! Test whether clipboard data can be exported through this converter
    virtual bool canConvertFromIClipboard(const std::string&) const { return true; }
    ...
    */
    ...
    //! Test whether this converter supports importing X11 selection data
    virtual bool canConvertToIClipboard() const { return true; }

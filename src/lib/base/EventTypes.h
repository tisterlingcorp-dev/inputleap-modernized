...
enum class EventType : std::uint32_t {
    ...
    */
    ...
    /// An IPC client was removed. Event data is its EIpcClientType.
    IPC_SERVER_CLIENT_DISCONNECTED,
    ...
    */
    ...
    /// This event is sent when a server rejects a client before completing secure accept.
    CLIENT_LISTENER_ACCEPT_FAILED,
    ...
    */
    ...
    /// A single client screen disconnected. Event data is ScreenConnectedInfo.
    SERVER_SCREEN_DISCONNECTED,

...
class ScreenLayoutEditorWidget;
...
class ServerConfigDialog : public QDialog
{
    ...
    public:
        ServerConfigDialog(QWidget* parent, ServerConfig& config, const QString& defaultScreenName, const QList<DeviceInfo>& devices = {});
    ...
    private:
        ...
        ScreenLayoutEditorWidget* m_LayoutEditor = nullptr;
        QStringList m_InitialLegacyNames;
